...
:copyright:
    ...
    Martin van Driel (Martin@vanDriel.de), 2013-2016
:license:
...
CLEAN_VERSION_NUMBER = bool(_pattern.match(pymesher.__version__))
...
def test_flake8():
    ...
    pymesher_dir = os.path.dirname(test_dir)

    # Ignore automatically generated files.
    ignore_files = []
    ignore_files = [os.path.join(pymesher_dir, _i) for _i in ignore_files]
    files = []
    for dirpath, _, filenames in os.walk(pymesher_dir):
